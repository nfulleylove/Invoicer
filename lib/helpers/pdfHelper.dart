...
pw.Column _header(InvoiceModel invoice) {
  return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
    ...
    pw.RichText(
        text: pw.TextSpan(children: <pw.TextSpan>[
      pw.TextSpan(
          text: 'NI: ', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
...
List<pw.Widget> _workDaysAndPaymentDetails(
    pw.Context context, InvoiceModel invoice) {
  return [
    pw.Text('Days Worked', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
        ...
        child: pw.Align(
          ...
          child: pw.RichText(
            ...
            pw.TextSpan(
                ...
                style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
            pw.TextSpan(text: '£${invoice.totalLabourCosts.toStringAsFixed(2)}')
          ])),
        )),
...
pw.Widget _table(pw.Context context, InvoiceModel invoice) {
...
pw.Container _footer(pw.Context context) {
  return pw.Container(
